    ...
    public class AvatarController : MonoBehaviour
    {
        ...
        public bool IsEnabled
        {
            ...
            set
            {
                ...
                // Update Entries
                foreach (var entry in _controllers.SelectMany(x => x.Bones).SelectMany(x => x.Properties.Values).Where(x => x.IsEnabled))
                {
                    entry.Update();
                }
            }
        ...
        public Dictionary<Transform, TransformData> ValidBones => _validBones.ToDictionary(x => x.Key, x => x.Value);
        #endregion
